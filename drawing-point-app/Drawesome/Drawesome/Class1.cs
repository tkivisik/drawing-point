...
namespace Drawesome
{
    public static class ImageResizer
    {
        ...
        public static async Task<byte[]> ResizeImage(byte[] imageData, double width, double height)
        {
#if __IOS__
        ...
        public static async Task<byte[]> ResizeImageWindows(byte[] imageData, double width, double height)
        {
            byte[] resizedData;
